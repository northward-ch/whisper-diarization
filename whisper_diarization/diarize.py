...
def diarize_audio(audio, out, stemming, suppress_numerals, model_name, batch_size, language, device):
    ...
    with open(f"{os.path.splitext(out)[0]}.srt", "w", encoding="utf-8-sig") as srt:
        write_srt(ssm, srt)
